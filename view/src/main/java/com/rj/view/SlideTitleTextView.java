...
public class SlideTitleTextView extends TextView {
    ...
    private int selectColor = Color.parseColor("#0c78bd"); //默认选中颜色
...
//			canvas.drawLine(0, this.getHeight() - scale, this.getWidth(),
//					this.getHeight() - scale, paint);
        }
    }
...
//		int padding = (int)getContext().getResources().getDimension(R.dimen.dp10);
